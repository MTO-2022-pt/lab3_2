...
public class Order {
    ...
    public void submit() {
        ...
        subbmitionDate = LocalDateTime.now(testClock);

    }

    public void confirm() {
        requireState(State.SUBMITTED);
        long hoursElapsedAfterSubmittion = subbmitionDate.until(LocalDateTime.now(testClock), ChronoUnit.HOURS);
